...
public class Font {
    ...
    public static final Font DEBUG_FONT = new Font(new java.awt.Font(java.awt.Font.MONOSPACED, java.awt.Font.BOLD, 15), true);
    ...
    private Texture createFontTexture(java.awt.Font font, boolean antiAlias) {
        ...
        Texture fontTexture = new Texture(imageWidth, imageHeight, buffer);
