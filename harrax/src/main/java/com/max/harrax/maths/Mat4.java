...
public class Mat4 {
    ...
    public Mat4(Vec4 col1, Vec4 col2, Vec4 col3, Vec4 col4) {
        this.elements[0] = col1.x;
        this.elements[4] = col2.x;
        this.elements[8] = col3.x;
        this.elements[12] = col4.x;
        this.elements[1] = col1.y;
        this.elements[5] = col2.y;
        this.elements[9] = col3.y;
        this.elements[13] = col4.y;
        this.elements[2] = col1.z;
        this.elements[6] = col2.z;
        this.elements[10] = col3.z;
        this.elements[14] = col4.z;
        this.elements[3] = col1.w;
        this.elements[7] = col2.w;
        this.elements[11] = col3.w;
        this.elements[15] = col4.w;
    }
    ...
    public Mat4 mult(final Mat4 right) {
        float[] oldElements = elements.clone();
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < 4; j++) {
                float sum = 0.0f;
                for (int k = 0; k < 4; k++) {
                    sum += oldElements[i + k * 4] * right.elements[k + j * 4];
                }
                elements[i + j * 4] = sum;
            }
        }
    ...
    public Mat4 transpose() {
        ...
        for (int row = 0; row < 4; row++) {
            for (int col = 0; col < 4; col++) {
                elements[row + col * 4] = oldElements[col + row * 4];
            }
        }
        return this;
    }
