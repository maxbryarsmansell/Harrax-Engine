...
public class Layer {
	...
	/*
	 * Attributes for A list of renderables in the layer A camera A shader program A
	 * renderer to render the renderables
	 */
	...
	public Layer(float width, float height) {
		this(new Shader("res/shaders/batch.vert", "res/shaders/batch.frag"), new Camera(width, height));
	}
